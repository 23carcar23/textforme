...
const demoContacts = [
  { chat_guid: 'demo-1', display_name: 'Mom', address: '+1 (555) 010-2222', is_group: false, ai_enabled: true, description: 'my very strict mom so be nice to her' },
  { chat_guid: 'demo-2', display_name: 'Alex Rivera', address: '+1 (555) 010-3333', is_group: false, ai_enabled: false, description: '' },
  { chat_guid: 'demo-3', display_name: 'Ski Trip 2026', address: '4 people', is_group: true, ai_enabled: false, description: '' },
  { chat_guid: 'demo-4', display_name: '', address: '+1 (555) 010-4444', is_group: false, ai_enabled: false, description: '' },
]
